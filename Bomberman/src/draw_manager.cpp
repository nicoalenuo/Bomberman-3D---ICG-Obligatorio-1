...
void Draw::DrawHUD(HUDComponent top_left, HUDComponent top_right, HUDComponent top_center) {
	...
	glBegin(GL_QUADS); {
		...
		glVertex3f(global->width, height + 6.f, 0.f);
		glVertex3f(global->width, 0.f, 0.f);
	...
	glBegin(GL_QUADS); {
		...
		glTexCoord2d(1.f, 1.f); glVertex3f(global->width, SCR_HEIGHT - 62.f, 1.f);
		glTexCoord2d(1.f, 0.f); glVertex3f(global->width, SCR_HEIGHT, 1.f);
...
void Draw::DrawHUDComponent(HUDComponent component) {
	...
	case HUDComponentIs::top_right:
		glBegin(GL_QUADS); {
			glTexCoord2d(0.f, 1.f); glVertex3f(global->width - 30.f - component.surface_message->w, 3.f + component.surface_message->h, 0.f);
			glTexCoord2d(1.f, 1.f); glVertex3f(global->width - 30.f, 3.f + component.surface_message->h, 0.f);
			glTexCoord2d(1.f, 0.f); glVertex3f(global->width - 30.f, 3.f, 0.f);
			glTexCoord2d(0.f, 0.f); glVertex3f(global->width - 30.f - component.surface_message->w, 3.f, 0.f);
		} glEnd();
		break;
	case HUDComponentIs::top_center:
		glBegin(GL_QUADS); {
			glTexCoord2d(0.f, 1.f); glVertex3f(global->width / 2.f - component.surface_message->w / 2, 3.f + component.surface_message->h, 0.f);
			glTexCoord2d(1.f, 1.f); glVertex3f(global->width / 2.f + component.surface_message->w / 2, 3.f + component.surface_message->h, 0.f);
			glTexCoord2d(1.f, 0.f); glVertex3f(global->width / 2.f + component.surface_message->w / 2, 3.f, 0.f);
			glTexCoord2d(0.f, 0.f); glVertex3f(global->width / 2.f - component.surface_message->w / 2, 3.f, 0.f);
		} glEnd();
		break;
	}
	glDisable(GL_TEXTURE_2D);
