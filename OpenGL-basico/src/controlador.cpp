...
Controlador::Controlador() {
    ...
    random_device rd;
    mt19937 gen(rd());
    uniform_real_distribution<> dis(0.0, 1.0); // Distribución uniforme entre 0 y 1
...
void Controlador::cargarTextura(){
    ...
    if (textura) {
        ...
        archivo1 = "../OpenGL-Basico/texturas/estT.jpg"; //sacar OpenGL-Basico
        ...
        archivo2 = "../OpenGL-Basico/texturas/estF.png"; //sacar OpenGL-Basico
...
void Controlador::explotarBomba(bomba* bomb) {
    ...
    for (auto it = this->bombas.begin(); it != this->bombas.end(); it++) {
        ...
        if (alcanzaX && alcanzaZ) {
            ...
            //aca hay que llamar al grafico para que haga efectos de exploción
